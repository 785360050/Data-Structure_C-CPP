...
{
	//Tree_Normal<bool,TreeNode<bool>>* tree=new Tree_Advanced_Parent<bool>(3);
	//Tree_Normal<bool, TreeNode_Child<bool>>* tree=new Tree_Advanced_Child<bool>(3);
	Tree_Normal<bool,Node_Tree_ChildSibling<bool>>* tree=new Tree_Advanced_ChildSibling<bool>(3);
