...
{
	template <typename DataType, typename KeyType = int, typename NodeType = Node_Binary_Search_RB<DataType, KeyType>>
	class Tree_Binary_Search_RBT : public Logic::Tree_Binary_Search<DataType, KeyType, NodeType>
	{
	public:
		Tree_Binary_Search_RBT() : Logic::Tree_Binary_Search<DataType, KeyType, NodeType>() {};
		~Tree_Binary_Search_RBT() = default;
	...
	public:
		...
		void Element_Delete(KeyType key) override
		{
			...
			{///del度为2时
				del = this->Node_Precursor(node);///逻辑前驱
			}
