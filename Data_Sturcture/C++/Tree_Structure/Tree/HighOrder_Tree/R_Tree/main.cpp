...
struct Rect_Test
{
	...
	Rect_Test(int a_minX, int a_minY, int a_maxX, int a_maxY)
	{
		min[0] = a_minX;
		min[1] = a_minY;
...
struct Rect_Test rects[] =
	{
		Rect_Test(0, 0, 2, 2), // xmin, ymin, xmax, ymax (for 2 dimensional RTree)
		Rect_Test(5, 5, 7, 7),
		Rect_Test(8, 5, 9, 6),
		Rect_Test(7, 1, 9, 2),
};
...
Rect_Test search_rect(6, 4, 10, 6); // search will find above rects that this one overlaps
