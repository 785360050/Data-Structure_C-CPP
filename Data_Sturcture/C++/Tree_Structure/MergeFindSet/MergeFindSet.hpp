...
// MergeFindSet 的完整 ADT 定义见：
// Document/ADT/Tree_Structure/MergeFindSet.md
//
// 当前项目约定：
// 1. 公共 ADT 只定义集合划分和合并语义
// 2. Find 和 Merge 的行为结果属于共享契约主体
// 3. Quick Find、Quick Union 等策略不属于共享契约主体
