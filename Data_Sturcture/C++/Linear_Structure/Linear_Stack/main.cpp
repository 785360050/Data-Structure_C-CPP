...
#include "Stack.hpp"
#include "Linear_Stack_Sequential/Sequential_Stack.hpp"
#include "Linear_Stack_Linked/Link_Stack.hpp"

template <typename StackType, typename ElementType>
	requires ADT::Linear_Stack<StackType, ElementType>
void TestStack()
{
...
int main()
{
	static_assert(ADT::Linear_Stack<Link_Stack<char>, char>);
	static_assert(ADT::Linear_Stack<Link_Stack<char>, char>);
	static_assert(ADT::Linear_Stack<Link_Stack<char>, char>);
	static_assert(ADT::Linear_Stack<Link_Stack<char>, char>);
	static_assert(ADT::Linear_Stack<Link_Stack<char>, char>);
